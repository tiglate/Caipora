...
class CustomCollectorsTest {
    ...
    void testToSortedMapOrder() {
        ...
        assertNotNull(result);
        assertEquals(3, result.size());
        assertEquals(List.of("banana", "apple", "cherry"), result.keySet().stream().toList());
    }
    ...
    void testPrivateConstructor() {
        ...
        for (Constructor<?> constructor : constructors) {
            ...
            assertInstanceOf(AssertionError.class, exception.getCause(), "Constructor should throw AssertionError");
        }
    }
}